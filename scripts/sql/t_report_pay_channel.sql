CREATE TABLE `t_report_pay_channel` (
...
) ENGINE=InnoDB AUTO_INCREMENT=329852 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='充值通道统计信息';
